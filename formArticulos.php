	...
	<?php 
		...
		if (($_COOKIE['tipoUsuario'] == null) or ($_COOKIE['tipoUsuario']) != 'autorizado')	{
			...
			if (isset($_GET['Editar'])) {
				...
				$datosProducto = ["ProductID" => "", "Name"=>"", "Cost"=>0, "Price"=>0, "categoria" => "PANTALÖN"];
			}
		}

	 ?>
	 <div class="mainForm">
		 <form class="formulario" action="formArticulos.php" method="GET">
		 	...
		 	<p><label>Categoria</label> <select name="categoria"><?php pintaCategorias($datosProducto['CategoryID']); ?></select></p>
